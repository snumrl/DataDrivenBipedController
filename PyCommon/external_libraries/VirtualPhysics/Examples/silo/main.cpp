...
glTexture		woodTex, patternTex, rustTex;
glMaterial		woodMaterial, patternMaterial, rustMaterial;
...
void setupCameraLight(void)
{
	...
	//light.setFOV(25.0f);
	light.setOrthoSize(-100, 100, -100, 100);
...
void init(void)
{
	...
	rustTex.setParameter(GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
