...
{
	camera.lookAt(68.4889,-72.2571,66.9731,35.1898,57.8859,6.32089);
	//camera.lookAt(-27.9525,19.9797,15.0554,30.9887,82.7722,23.073);
	camera.setFOV(45.0f);
...
void init(void)
{
	...
	//shaderProgram.setMask(&vertexShader, 1);
	//shaderProgram.setMask(&fragmentShader, 1);
