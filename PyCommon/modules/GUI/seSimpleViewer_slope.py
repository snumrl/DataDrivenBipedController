...
#        self.box(FL_PLASTIC_UP_BOX)
        ...
        self.direction_1 = Fl_Button(70,60-but_height,but_width,but_height,'0')
        ...
        self.direction_3 = Fl_Button(70-but_width,60,but_width,but_height,'90_L')
        self.direction_3.callback(self.but_callback,90)
        self.direction_4 = Fl_Button(70+but_width,60,but_width,but_height,'90_R')
        ...
        self.direction_6 = Fl_Button(70,60+but_height,but_width,but_height,'180')
        ...
        self.angle_value_slider.bounds(90, -90)
...
#        self.speed_but_cb(int(ptr.value()))
    ...
    def angle_value_input_cb(self,ptr):
        self.angle_value_slider.value(int(ptr.value()))
        if int(ptr.value()) < 0:
            self.angle_but_cb(int(360+ptr.value())) 
        else:
            self.angle_but_cb(int(ptr.value()))
